  ...
  return (
    <section className="mt-3.5 ">
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
        <div className="w-52 h-20 bg-[#FCC0C5] text-[#6D123F] rounded-md font-semibold text-xl flex items-center justify-center sm:w-44 lg:w-44 gap-4">
          <CalendarClock/>
          <p className="text-lg font-medium">Berlangsung</p>
        </div>
        <div className="flex items-center justify-start gap-3 w-52 h-20 p-2.5 bg-[#FCC0C5] text-[#6D123F] rounded-md sm:w-44 lg:w-44">
        ...
        <div className="flex items-center justify-start gap-3 w-52 h-20 p-2.5 bg-[#FCC0C5] text-[#6D123F] rounded-md sm:w-44 lg:w-44">
          ...
          <p className="text-sm">50 penerima</p>
          </div>
        </div>
        <div className="flex items-center justify-start gap-3 w-52 h-20 p-2.5 bg-[#FCC0C5] text-[#6D123F] rounded-md sm:w-44 lg:w-44">
