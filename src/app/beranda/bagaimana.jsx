        ...
        <div className="stat shadow grid grid-cols-1 sm:grid-cols-4 lg:grid-cols-4 gap-8">
            ...
            <div className="stat p-6 flex flex-col items-center text-center hover:shadow-xl transition">
                <div className="rounded-full p-2 bg-[#F4F4FF] mb-4">
                    <UserLock className="stat-figure w-10 h-10 text-purple-600" />
                </div>
            ...
            <div className="stat p-6 flex flex-col items-center text-center hover:shadow-xl transition">
                <div className="rounded-full p-2 bg-[#F4F4FF] mb-4">
                    <ClipboardList className="stat-figure w-10 h-10 text-purple-600" />
                </div>
            ...
            <div className="stat p-6 flex flex-col items-center text-center hover:shadow-xl transition">
                <div className="rounded-full p-2 bg-[#F4F4FF] mb-4">
                    <View className="stat-figure w-10 h-10 text-purple-600" />
                </div>
            ...
            <div className="stat p-6 flex flex-col items-center text-center hover:shadow-xl transition">
                <div className="rounded-full p-2 bg-[#F4F4FF] mb-4">
                    <Boxes className="stat-figure w-10 h-10 text-purple-600" />
                </div>
