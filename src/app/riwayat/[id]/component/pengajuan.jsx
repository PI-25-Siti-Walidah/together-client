...
export default function Pengajuan() {
  const dataPengajuan = {
    ...
    status: "Diterima",
    alasan:
      "Pemohon terverifikasi dan sesuai kriteria keluarga rentan ekonomi.",
  };
  ...
  return (
    <section className="bg-white rounded-2xl shadow-md p-4 sm:p-6">
      ...
      <div className="space-y-2 text-gray-700 text-sm sm:text-base">
        <p>
          <strong>ID Pengajuan:</strong> {dataPengajuan.id}
        </p>
        <p>
          <strong>Tanggal Update:</strong> {dataPengajuan.tanggal}
        </p>
        ...
        <p>
          <strong>Alasan:</strong> {dataPengajuan.alasan}
        </p>
      </div>
    </section>
  );
