...
export default function DetailBantuan() {
  ...
  if (loading)
    return <p className="text-center mt-10">Memuat data bantuan...</p>;
  if (!selectedBantuan)
    return (
  ...
  const formUmum = [
    ...
    {
      id: "u5",
      label: "Pekerjaan utama saat ini",
      type: "text",
      required: true,
    },
    {
      id: "u6",
      label: "Pendapatan rata-rata per bulan",
      type: "number",
      required: true,
    },
    {
  ...
  const formKategori = [
    {
      id: "k1",
      label: "Jumlah anggota keluarga bekerja",
      type: "number",
      required: true,
    },
    {
      id: "k2",
      label: "Total penghasilan keluarga per bulan",
      type: "number",
      required: true,
    },
    {
      id: "k3",
      label: "Pengeluaran rutin (sewa, listrik, sekolah, makan)",
      type: "text",
      required: true,
    },
    {
      id: "k4",
      label: "Kendala ekonomi paling mendesak",
      type: "text",
      required: true,
    },
    {
      id: "k5",
      label: "Apakah ada anggota keluarga yang sakit menahun / disabilitas?",
      type: "radio",
      required: true,
    },
  ];
  ...
  const formBantuan = [
    {
      id: "b1",
      label: "Apa kebutuhan pangan utama (beras, lauk, sayur)?",
      type: "text",
      required: true,
    },
    {
      id: "b2",
      label: "Akses tempat pengambilan bantuan?",
      type: "text",
      required: true,
    },
    {
      id: "b3",
      label:
        "Dalam sebulan terakhir, adakah hari di mana keluarga makan kurang dari 2 kali sehari?",
      type: "text",
      required: true,
    },
    {
      id: "b4",
      label:
        "Apakah lokasi tempat tinggal sulit dijangkau untuk pembelian bahan pokok (pasar jauh, transportasi sulit)?",
      type: "text",
      required: true,
    },
  ];
